...
class TestMongoConn:
    ...
    def mongo_create_index_sensor_remote_test(self):
        val = MongoConn()
        val.mongodb_conn('reahbilitation_db_test',
                     'sensor_coll',
                     'mongodb://ec2-3-14-14-152.us-east-2.compute.amazonaws.com:27017/test')
    ...
    def insert_data_many_remote_test(self, list_collect, samples, type_check):
        ...
        for a in range(0, samples):
            ...
            values['pitch'] = 3.11111111111111111
            values['median_pitch'] = 3.11111111111111112
            values['roll'] = 3.11111111111111113
            values['median_roll'] = 3.11111111111111114
            values['yam'] = 3.11111111111111115
            values['median_yam'] = 3.11111111111111116
            values['game_selection'] = 'Game1'
            values['name_patient'] = 'Carlos'
            values['id_patient'] = 1001
            if type_check == '25FREE':
                values['free1'] = 3.11111111111111111
                values['free2'] = 3.11111111111111111
                values['free3'] = 3.11111111111111111
                values['free4'] = 3.11111111111111111
        ...
        try:
            flag = test_conn.insert_data_many(values_all)
            list_collect[0].append(0)
        except:
            flag = 1
            list_collect[0].append(1)
        list_collect[1].append((datetime.now() - time_bef).total_seconds())
    ...
    def insert_data_many_test(self):
        ...
        t = datetime.now()
        values['datetime'] = t
        values['datetime_int'] = lambda: int(round(time.time() * 1000))
        values['pitch'] = 3.11111111111111112
        values['median_pitch'] = 3.11111111111111113
        values['roll'] = 3.11111111111111114
        values['median_roll'] = 3.11111111111111115
        values['yam'] = 3.11111111111111116
        values['median_yam'] = 3.11111111111111117
        values['game_selection'] = 'Game1'
        values['name_patient'] = 'Carlos'
        values['id_patient'] = 1001
